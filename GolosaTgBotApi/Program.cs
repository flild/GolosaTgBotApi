...
//todo обычные файлы, типо txt и тд. надо тоже обрабатывать
/*
- брать все файлы, если слишком большой, то перенаправляем напрямую в тг
-
- репост поста в канал (вроде норм, отмечает)
- реакции
?*/
//todo миграция базы.

//todo сделать контроллеры, с выводом файлов и тд. нужно получать пост, коменты, посты в виде скролл ленты